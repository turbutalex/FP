...
def ui_modifica_pachet(l,ul):
    ...
    try:
        ...
        destinatie = input("destinatia: ")
        pret = int(input("pret: "))
        modifica_pachet(ul,l,i,zi_inceput,luna_inceput,an_inceput,zi_sfarsit,luna_sfarsit,an_sfarsit,destinatie,pret)
...
def ui_sterge_cu_destinatie(l,ul):
    """
    ...
    try:
        ...
        print("Valoare invalida")
    sterge_cu_destinatie(destinatie,l,ul)

def ui_sterge_cu_durata_mai_mica(l,ul):
    """
    functia de ui pt functia sterge_cu_durata_mai_mica
    """
    try:
        ...
        print("Valoare invalida")
    sterge_cu_durata_mai_mica(durata,l,ul)

def ui_sterge_cu_pret(l,ul):
    """
